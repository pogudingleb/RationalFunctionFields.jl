@testset "RationalFunctionField" begin
    ...
    f1 = [a, b, a + b + c]
    f2 = [2c, 3b, 5a]
    rff1 = RationalFunctionField(f1)
    rff2 = RationalFunctionField(f2)
    @test fields_equal(rff1, rff2, p)
    ...
    g4 = x1 * x2^2 + 5x1 * x2
    g5 = x1^3 * x2 - x2
    rff1 = RationalFunctionField([g1, g2, g3, g4, g5])
    rff2 = RationalFunctionField([x1, x2])
    @test fields_equal(rff1, rff2, p)
end
